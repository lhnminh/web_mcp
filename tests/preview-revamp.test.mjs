...
test('3D model scaling calibrates against each complete modeled height', () => {
  const envelopes = [
    ...
    ['stove', '0.76', '0.61', '0.91'], ['sink', '0.76', '0.61', '1.05'], ['fridge', '0.91', '0.76', '1.78'], ['toilet', '0.4', '0.7', '0.78'], ['shower', '0.91', '0.91', '2'], ['bathtub', '1.76', '0.75', '0.58'], ['washer-dryer', '0.6', '0.65', '0.85'],
    ['other', '0.8', '0.8', '0.8'],
  ];
