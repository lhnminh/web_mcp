...
export const ACTION_MANIFEST: readonly ActionManifestEntry[] = [
  ...
  covered({ id: 'finish.list', surface: 'editor', effect: 'read', humanEntryPoints: ['3D Finish Studio part picker'], sharedCommand: 'finishTargetStates', webMcpTool: 'dwellwise.list_finish_targets', availability: 'Owned project and active layout are loaded', testIds: ['webmcp.finish.targets', 'webmcp.pagination'] }),
  ...
  covered({ id: 'finish.update', surface: 'editor', effect: 'undoable_write', humanEntryPoints: ['Double-click a 3D surface', 'Apply finish', 'Reset finish'], sharedCommand: 'updateMaterialFinish', webMcpTool: 'dwellwise.update_finish', availability: 'Owned project is loaded and a valid material target is selected', testIds: ['webmcp.finish.update', 'materials.harmony'] }),
  ...
  covered({ id: 'exterior_corner.add', surface: 'editor', effect: 'undoable_write', humanEntryPoints: ['Right-click exterior wall'], sharedCommand: 'addExteriorCornerCommand', webMcpTool: 'dwellwise.add_exterior_corner', availability: 'Eligible exterior wall is loaded', testIds: ['webmcp.architecture'] }),
